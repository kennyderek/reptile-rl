...
class Prelim_Maze:
    ...
    def __init__(self, num_rows, num_cols, num_walls, start = (0, 0), goal = (4, 1)):
        ...
        if start is None:
            ...
            self.start = self.get_cell(start[1], start[0])
        ...
        for row in range(self.num_rows):
            for col in range(self.num_cols):
                ...
                if row == self.start.row and col == self.start.col:
                    new_maze[new_row][new_col].make_start()
                elif row == self.goal[1] and col == self.goal[0]:
                    new_maze[new_row][new_col].make_goal()
            ...
            for row in range(num_rows):
                ...
                new_maze[row][num_cols-1].set_wall()
...
class Random_Maze:
    ...
    def __init__(self, num_rows, num_cols, num_walls, start = None, goal = None):
        prelim_maze = Prelim_Maze(num_rows, num_cols, num_walls, start, goal)
        ...
        if goal is None:
            ...
            self.goal = self.get_cell(2*goal[1]+1, 2*goal[0]+1)
    ...
    def get_array_maze(self):
        ...
        for new_row in range(self.num_rows):
            for new_col in range(self.num_cols):
                ...
                row = cell.row
                col = cell.col
                if row == self.goal.col and col == self.goal.row:
                    new_maze[new_row][new_col] = ' '
                else:
                    new_maze[new_row][new_col] = str(cell)
        return new_maze
